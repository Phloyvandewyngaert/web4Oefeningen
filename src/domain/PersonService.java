...
//les CRUD
	...
	public void addLes(Les les) {
		getPersonRepository().addLes(les);
	}

	public Les getLes(String naamLes)  {	return getPersonRepository().getLes(naamLes);	}

	public List<Les> getLessen() {
		return getPersonRepository().getAllLessen();
	}

//cadeau

	public void addCadeau(Cadeau c) {
		getPersonRepository().addCadeau(c);
	}

	public Cadeau getCadeau(String omschrijving)  {	return getPersonRepository().getCadeau(omschrijving);	}

	public List<Cadeau> getCadeaus() {
		return getPersonRepository().getAllCadeaus();
	}
